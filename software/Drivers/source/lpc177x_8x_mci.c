 ...
 * @return       MCI_FUNC_OK in case of success
 * 
 * 0000: This function has been modified for my GPS thingy
 * NOTE: Pins used on my GPS thingy are:
 * CLK	P0.19
 * CMD	P0.20
 * PWR	(unused) P0.21
 * DAT0	P0.22
...
int32_t MCI_Init(uint8_t powerActiveLevel )
{
    ...
    //LPC_IOCON->P1_12 &= ~0x1F; /* SD_DAT_3 @ P1.12 */ //NOTE: This line initially lacked a "~" (was: 0x1F)
    ...
    //LPC_GPIO1->CLR = 0x1000; //P1_12 (DAT3)
    //LPC_GPIO1->CLR = 0x0800; //P1_11 (DAT2)
    //LPC_GPIO1->CLR = 0x0080; //P1_7  (DAT1)
    //LPC_GPIO1->CLR = 0x0040; //P1_6  (DAT0)
  
    //LPC_GPIO1->SET = 0x0020; //P1_5  (PWR)
  
    //LPC_GPIO1->CLR = 0x0008; //P1_3  (CMD)
    //LPC_GPIO1->CLR = 0x0004; //P1_2  (CLK)
    
    LPC_GPIO2->CLR = (1<<13); //P2_13 (DAT3)
    LPC_GPIO2->CLR = (1<<12); //P2_12 (DAT2)
    LPC_GPIO2->CLR = (1<<11); //P2_11 (DAT1)
    LPC_GPIO0->CLR = (1<<22); //P0_22 (DAT0)
  
    LPC_GPIO0->SET = (1<<21); //P0_21 (PWR)
  
    LPC_GPIO0->CLR = (1<<20); //P0_20 (CMD)
    LPC_GPIO0->CLR = (1<<19); //P0_19 (CLK)
